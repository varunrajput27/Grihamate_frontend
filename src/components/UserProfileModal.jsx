...
// 'isOpen' और 'onClose' props Layout component से आएंगे
const UserProfileModal = ({ isOpen, onClose }) => {
    // Auth context से user data fetch किया
    const { user } = useAuth(); 

    if (!isOpen) return null;

    // Default values अगर user data missing हो 
    ...
    return (
        ...
        <div 
            ...
            onClick={onClose} // Backdrop पर क्लिक करने पर बंद हो जाए
        >
            {/* Modal Content */}
            <div 
                className="bg-white rounded-xl shadow-2xl max-w-lg w-full transform transition-all duration-300 scale-100 opacity-100"
                onClick={(e) => e.stopPropagation()} // Modal के अंदर क्लिक करने पर बंद न हो
            >
                {/* Header */}
                ...
                <div className="p-6 space-y-4">
                    ...
                    <div className="space-y-3">
                        ...
                        {/* Add Edit Button or other fields here */}
                        {/* <div className="pt-4">
                           <button className="w-full py-2 bg-indigo-600 text-white font-semibold rounded-lg hover:bg-indigo-700 transition duration-150">
                                Edit Profile
                           </button>
                        </div> */}
                    </div>
