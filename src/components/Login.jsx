...
//         <span className="text-[#3d5a80] font-semibold">Home</span>
//       </button>

//       <div className="bg-white p-10 rounded-3xl shadow-2xl w-full max-w-md">
//         <h2 className="text-3xl font-bold mb-6 text-center text-[#3d5a80]">Login</h2>
...
//               maxLength={10}
//               className="w-full border border-gray-300 rounded px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#3d5a80]"
//             />
//           </div>
...
//       className="w-full border border-gray-300 rounded px-4 py-3 pr-10 focus:outline-none focus:ring-2 focus:ring-[#3d5a80]"
//     />
//     <button
//       type="button"
...
//               className="text-[#3d5a80] hover:underline cursor-pointer font-medium"
//             >
//               Forgot Password?
//             </button>
//           </div>
...
//           <span className="text-gray-600 font-small">Don’t have an account? </span>
//           <Link
//             to="/register"
