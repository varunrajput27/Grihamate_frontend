...
// const Footer = () => {
//   return (
//     <footer className="bg-[#0b0b2b] text-white px-6 md:px-12 py-8">
//       {/* Top Section */}
...
//             />
//           </div>
//           <h2 className="text-lg font-bold mb-2">Grihamate</h2>
//           <p className="text-sm text-gray-300 leading-relaxed mb-3">
//             Your trusted partner in finding the perfect residential and
...
//               <MdPhone className="text-lg" /> +91-9999999999
//             </li>
//             <li className="flex items-center gap-3">
//               <MdEmail className="text-lg" /> Grihamate@gmail.com
//             </li>
...
//       {/* Bottom Section */}
//       <div className="flex flex-col sm:flex-row justify-between items-center pt-4 text-xs text-gray-400 gap-3 mt-1">
...
//           </Link>
//         </div>
//         <div>© {new Date().getFullYear()} Grihamate. All Rights Reserved.</div>
//       </div>
//     </footer>
//   );
// };
    ...
    <footer className="bg-[#0b0b2b] text-white px-4 sm:px-8 md:px-12 py-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 border-b border-gray-700 pb-8">
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-gray-300">
            <li className="flex items-center gap-3">
              <MdPhone className="text-lg sm:text-xl" /> +91-9999999999
            </li>
            <li className="flex items-center gap-3">
              <MdEmail className="text-lg sm:text-xl" /> Grihamate@gmail.com
            </li>
            <li className="flex items-start gap-3">
